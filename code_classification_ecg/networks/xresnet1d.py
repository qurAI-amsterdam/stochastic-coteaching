...
class XResNet1d(nn.Sequential):
    ...
    def __init__(self, block, expansion, layers, p=0.0, input_channels=3, num_classes=1000, stem_szs=(32,32,64),kernel_size=5,kernel_size_stem=5,
        ...
        layers_tmp.append(nn.Linear(block_szs[-1]*expansion*2, 128, bias=False))
...
def xresnet101_ptbxl(in_channels, num_classes):
    return _xresnet1d(4, [3, 4, 23, 3], num_classes = num_classes, input_channels = in_channels)


if __name__ == '__main__':
    import torchinfo
    model = xresnet101_ptbxl(12, 5)
